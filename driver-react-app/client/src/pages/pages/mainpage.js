...
function setDestination(latlng) {
  ...
  // Optional: Draw route from driver to destination
  drawRoute();
...
// Function to draw route between driver and destination
function drawRoute() {
...
// Example usage:
// setDestination({lat: 40.7128, lng: -74.0060});
// updateDriverLocation({lat: 40.7127, lng: -74.0059});
