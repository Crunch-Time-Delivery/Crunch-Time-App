  ...
  return (
    <div className="header">
      <div className="menu-container">
        <div className="menu-icon" title="Menu" onClick={toggleMenu} style={{ cursor: 'pointer', fontSize: '24px' }}>
          ☰
        </div>
        <div id="menuDropdown" style={{ display: 'none', position: 'absolute', top: '40px', left: 0, background: '#fff', border: '1px solid #ccc', boxShadow: '0 2px 8px rgba(0,0,0,0.2)', padding: '10px', flexDirection: 'column', gap: '10px', zIndex: 1000 }}>
